...
Revision ID: c33b706a272e
Revises: 
Create Date: 2024-07-15 10:47:28.969512
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['caregiver_id'], ['caregivers.cid'], ),
    sa.ForeignKeyConstraint(['patient_id'], ['patients.pid'], ),
    sa.UniqueConstraint('patient_id', 'caregiver_id', name='uix_patient_caregiver')
    )
    ...
    op.create_table('mealentryaudit',
    sa.Column('me_auid', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('meid', sa.Integer(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('updated_by', sa.String(length=256), nullable=True),
    sa.ForeignKeyConstraint(['meid'], ['mealentry.meid'], ),
    sa.PrimaryKeyConstraint('me_auid')
    )
